...
import { refundsAPI } from '../lib/api.js';
...
const RefundsModule = () => {
  ...
  const loadRefunds = async () => {
    try {
      ...
      const response = await refundsAPI.getRefunds(params);
      ...
      setError(error.response?.data?.message || 'Error cargando reembolsos');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-2">
            Monitorea y gestiona todos los reembolsos
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  placeholder="ID de reembolso, ID de pago..."
          ...
          {loading ? (
            <div className="flex items-center justify-center h-64">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-600">Cargando reembolsos...</span>
              </div>
            </div>
          ) : refunds.length > 0 ? (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-12 gap-4 p-3 bg-gray-50 rounded-lg text-sm font-medium text-gray-700">
                <div className="col-span-3 flex items-center space-x-2">
                  ...
                  <span>ID Reembolso / ID Pago</span>
                </div>
              ...
              {refunds.map((refund, index) => (
                <div key={refund.refund_id || index} className="grid grid-cols-12 gap-4 p-3 bg-white rounded-lg border border-gray-200 hover:shadow-md transition-shadow">
                  <div className="col-span-3">
                    <p className="font-medium text-gray-800 text-sm">
                      {refund.refund_id || `ref_${index}`}
                    </p>
                    <p className="text-xs text-gray-500">
                      Pago: {refund.payment_id || 'N/A'}
                    </p>
                  </div>
                  ...
                  <div className="col-span-2">
                    <div className="flex items-center space-x-1 text-sm text-gray-600">
                      ...
                      <span>{formatDate(refund.created || new Date().toISOString())}</span>
                    </div>
                  </div>
            ...
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-medium text-gray-800 mb-2">
                No hay reembolsos disponibles
              </h3>
              <p className="text-gray-600">
                Los reembolsos aparecerán aquí cuando se procesen
              </p>
            </div>
          )}
        </CardContent>
